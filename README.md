...
[![Wi--Fi Latest](https://img.shields.io/badge/Wi--Fi_Latest-v24.50.0.4-blue?style=flat-square)](https://www.intel.com/content/www/us/en/search.html#q=wi-fi)[![Wi--Fi Database](https://img.shields.io/badge/Wi--Fi_Database-20.05.2026-blue?style=flat-square)](https://github.com/FirstEverTech/Universal-Intel-Chipset-Updater/blob/main/data/intel-chipset-infs-latest.md)[![BT Latest](https://img.shields.io/badge/BT_Latest-v24.50.0.4-blue?style=flat-square)](https://www.intel.com/content/www/us/en/search.html#q=bluetooth)[![BT Database](https://img.shields.io/badge/BT_Database-08.05.2026-blue?style=flat-square)](https://github.com/FirstEverTech/Universal-Intel-Chipset-Updater/blob/main/data/intel-chipset-infs-latest.md)
...
**v2026.07.0008** → [Release Notes](https://github.com/FirstEverTech/Universal-Intel-WiFi-BT-Updater/releases/tag/v2026.07.0008)
...
- **Improved Signature Verification** — Enhanced digital signature validation to support all Microsoft WHCP certificate variants used over the years, ensuring compatibility with older driver CAB packages while maintaining strict security standards.
- **Code Cleanup** — All comments have been converted to English for better maintainability and consistency.

### 🔧 **Technical Improvements**
- **Credits Screen**: External configuration via `intel-wifi-bt-credits.txt` and `intel-wifi-bt-ads.txt`
- **Backward Compatibility**: Falls back to `intel-wifi-bt-message.txt` if new files are missing
- **Interactive Keys**: Support keys 1-5 (Patreon, PayPal, Coffee, Ko-Fi, GitHub) and A-E (promotional links)

### 🐛 **Bug Fixes**
- None in this release — this is a maintenance and enhancement release.
...
**v2026.06.0007** → [Release Notes](https://github.com/FirstEverTech/Universal-Intel-WiFi-BT-Updater/releases/tag/v2026.06.0007)

### 🆕 **Highlights**
- **PSGallery Self‑Update** — When the script is installed from the PowerShell Gallery (`Install-Script`), it now updates itself automatically via `Update-Script` instead of downloading an EXE. This brings the same seamless experience as the Chipset Updater.
- **Installation Order Changed** — Bluetooth driver is now installed **before** Wi-Fi. This prevents the download failure that occurred when Wi-Fi installation disconnected the network before Bluetooth could be downloaded.

### 🐛 **Bug Fixes**
- **Network loss during dual‑driver update** — Previously, if both Wi-Fi and Bluetooth needed updates, the Wi-Fi driver was installed first, often disconnecting the internet. The subsequent attempt to download the Bluetooth driver would fail. Fixed by swapping the installation order.

### 🔧 **Compatibility**
- Fully backward compatible with all existing databases and CAB files.
- No changes to detection logic, hash verification, or digital signature checks.
