...
if not exist "!SCRIPT_DIR!universal-intel-wifi-bt-driver-updater.ps1" (
...
powershell -ExecutionPolicy Bypass -File "universal-intel-wifi-bt-driver-updater.ps1.ps1"
